        ...
        <Card className="border border-border bg-card">
          ...
          <CardContent className="p-0 border-t border-border">
            <table className="w-full text-xs text-left">
              ...
              <tbody>
                {users.map((u) => (
                  <tr key={u._id} className="group border-b border-border last:border-0 transition-soft hover:bg-muted/50">
                    <td className="px-4 py-4 font-semibold text-foreground group-hover:text-primary transition-colors">{u.name}</td>
                    <td className="px-4 py-4 font-mono text-muted-foreground">{u.email}</td>
                    <td className="px-4 py-4">
                      <span className="px-2 py-0.5 rounded-md text-[10px] uppercase font-bold bg-accent border border-border/50 text-foreground tracking-tight">
                        {u.role.replace("_", " ")}
                      </span>
                    </td>
                    <td className="px-4 py-4 text-right">
                      <select
                        ...
                        className="rounded-lg border border-border bg-background px-3 py-1.5 text-xs text-foreground outline-none focus:border-primary transition-soft"
                      >
                        <option value="ADMIN">ADMIN</option>
                        <option value="FLEET_MANAGER">FLEET MANAGER</option>
                        <option value="SAFETY_OFFICER">SAFETY OFFICER</option>
